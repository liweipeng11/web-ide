...
export * from "./commandInteraction.js";
export * from "./commandExecutionMetrics.js";
export * from "./shellCapability.js";
...
const commandExecutionStore = new CommandExecutionStore({
  ...
  retentionLimit: config.commandExecutionRetentionLimit,
  retentionDays: config.commandExecutionRetentionDays,
  maxLogFileBytes: config.commandExecutionMaxLogFileBytes,
  maxWorkspaceLogBytes: config.commandExecutionMaxWorkspaceLogBytes
});
