...
export const evaluationScenarios: EvaluationScenario[] = [
  ...
  { id: "near_context_limit_summary", title: "接近上下文上限仍完成总结", instruction: "在长上下文后给出完成总结", files: { "context.txt": "context ".repeat(50000) }, expected: { success: true } }
];
